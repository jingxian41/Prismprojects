...
$CNVNATOR -root $filebname.root -his 200 -d $REFERENCE
$CNVNATOR -root $filebname.root -stat 200
$CNVNATOR -root $filebname.root -partition 200
$CNVNATOR -root $filebname.root -call 200 > $filebname.OUT
